 ...
 * globals.css that overrides the surface variables only — the brand ramp is
 * deliberately shared by every tint, so buttons, links, and badges never
 * change colour and can never become hard to read against their own
 * backgrounds.
 *
...
export const TINTS = [
  ...
  // No violet/purple. It was removed deliberately — purple is the default
  // "this was generated by AI" colour, which is the exact impression this
  // product can least afford. Don't add it back.
