...
export function PracticeFilters({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-card p-3">
      <select
        value={current.topic ?? ""}
        onChange={(e) => update({ topic: e.target.value || undefined })}
        className="rounded-md border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-3 py-2 text-sm text-slate-600 dark:text-slate-300 focus:border-foreground focus:outline-none focus:ring-2 focus:ring-ember-600/30"
      >
      ...
      >
        <input
          ...
          className="w-48 rounded-md border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-3 py-2 text-sm text-slate-600 dark:text-slate-300 focus:border-foreground focus:outline-none focus:ring-2 focus:ring-ember-600/30"
        />
      </form>
