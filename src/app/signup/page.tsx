          ...
          <form action={formAction} className="space-y-4">
            ...
            <div className="flex items-start gap-2.5">
              <input
                ...
                type="checkbox"
                required
                className="mt-0.5 h-4 w-4 shrink-0 rounded border-slate-300 dark:border-slate-600 text-brand-600 dark:text-brand-400 focus:ring-foreground"
              />
              <label htmlFor="termsAccepted" className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
                I agree to the{" "}
                <Link href="/legal/terms" target="_blank" className="link font-semibold">
                  Terms of Service
                </Link>{" "}
                (including the limitation of liability in Section 11) and{" "}
                <Link href="/legal/privacy" target="_blank" className="link font-semibold">
                  Privacy Policy
                </Link>
