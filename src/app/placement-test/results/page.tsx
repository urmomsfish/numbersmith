    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        <div className="text-center">
          ...
          <h1 className="text-sm font-semibold uppercase tracking-wide text-slate-700 dark:text-slate-500">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-card p-6 text-center">
            ...
            <p className="mt-1 text-xs text-slate-700 dark:text-slate-500">Tier: {tier.label}</p>
          </div>
          <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-card p-6 text-center">
            <p className="text-xs font-semibold uppercase tracking-wide text-slate-700 dark:text-slate-500">
            ...
            {entries.map((e) => (
              <div key={e.slug}>
                <div className="mb-1.5 flex items-center justify-between text-sm">
                  ...
                  <span className="font-semibold text-slate-700 dark:text-slate-400">{e.percent}%</span>
                </div>
                <ProgressBar
                  value={e.percent}
